...
const Index = ({ tasks }) =>
{
  ...
  {
    if (!p && p !== 0) return "Medium"; // default

    if (typeof p === "number")
    {
      return p === 0 ? "Low" : p === 1 ? "Medium" : "High";
    }
                  ...
                  <div className="w-64 shrink-0">
                    {sortedTasks.map((task, index) =>
                    {
                      ...
                      return (
                        <div
                          key={task.taskId}
                          className={`px-4 border-r border-b border-gray-100 flex items-center ${index % 2 === 0 ? 'bg-white' : 'bg-gray-50/50'
                            }`}
                          style={{ height: '60px' }}
                        >
                          <div>
                  ...
                  <div className="flex-1 relative">
                    ...
                    {sortedTasks.map((task, index) =>
                    {
                      ...
                      return (
                        <div
                          key={task.taskId}
                          className={`relative px-2 border-b border-gray-100 ${index % 2 === 0 ? 'bg-white' : 'bg-gray-50/50'
                            }`}
                          style={{ height: '60px' }}
                        >
                          <div
